...
<h2><p style="font-size:45px"> Beers </p></h2>
...
//create a query
$query = "SELECT BeerName, Brewery, ABV, BeerType FROM beers";
...
if($response){
	...
	<tr><td align="left"><b>BeerName</b></td>
	<td align="left"><b>Brewery</b></td>
	<td align="left"><b>ABV</b></td>
	<td align="left"><b>Type of Beer</b></td></tr>';

	while($row = mysqli_fetch_array($response)){

		echo '<tr><td align="left">' .
		$row['BeerName'] . '</td><td align="left">' .
		$row['Brewery'] . '</td><td align="left">' .
